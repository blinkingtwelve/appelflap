...
- `web-origin` - the origin domain of the cache object or the scope of the serviceworker, base64-encoded. Typically, this will be the value of `btoa(self.origin)`.
- `cache-name` - Cache name or serviceworker URL, base64-encoded.
